...
class SubjectCollectionViewController: UICollectionViewController {
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "actionCell", for: indexPath) as! SubjectCollectionViewCell
        cell.subjectTitle.text     = Subjects.subjects[indexPath.row].title
        cell.backgroundColor       = Subjects.subjects[indexPath.row].color
        cell.layer.backgroundColor = (Subjects.subjects[indexPath.row].color as! CGColor)
